                ...
                <Wrapper>
                    <div className="mx-[20px] xl:mx-0">
                        ...
                        <div className="text-center pt-[130px]">
                            <h2 className="text-[30px] md:text-[42px] font-[600] leading-[1.23]">+1 123 456 78 90 <br />hello@mycompany.com</h2>
                            <p className="text-[24px] font-[300] py-[45px]">Укажите адрес вашей компании</p>
